...
class SAEM(object):
    ...
    def bert_data(self, images, images_tag, input_ids, attention_mask, token_type_ids, lengths, ids, expand_words):
        return images, images_tag, input_ids, attention_mask, token_type_ids, lengths, ids, expand_words

    def forward_emb(self, epoch, batch_data, volatile=False):
        """Compute the image and caption embeddings
        """
        images, images_tag, input_ids, attention_mask, token_type_ids, lengths, ids, expand_words = self.bert_data(*batch_data)
        ...
        # forward image
        img_code = self.img_enc(images, images_tag)

        # forward text
        cap_code = self.txt_enc(input_ids, attention_mask, token_type_ids, lengths, img_code, expand_words)
        cap_lens = lengths
